...
class WP_Email_Template_Style_Header_Settings extends WP_Email_Tempate_Admin_UI
{
	...
	public function subtab_data() {
		...
		$subtab_data = array(
			'name'				=> 'style-header',
			'label'				=> __( 'Email Header', 'wp_email_template' ),
		...
		if ( is_admin() && in_array (basename($_SERVER['PHP_SELF']), array('admin.php') ) && isset( $_GET['page'] ) && $_GET['page'] == 'wp_email_template' ) {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
           	...
           	array(
				'name' 		=> __( 'Title Alignment', 'wp_email_template' ),
				'id' 		=> 'header_alignment',
				'type' 		=> 'select',
				'default'	=> 'left',
				'options'	=> array(
			...
			array(
				...
				'desc'		=> __( 'Margin or space outside of the Title container border in px.', 'wp_email_template' ),
				'id' 		=> 'header_margin',
			...
			array(
				...
				'desc'		=> __( 'Padding or space between the border and the Title.', 'wp_email_template' ),
				'id' 		=> 'header_padding',
				'type' 		=> 'array_textfields',
				'ids'		=> array(
	 								array(
											'id' 		=> 'header_padding_top',
	 										...
	 										'css'		=> 'width:40px;',
	 										'default'	=> 24 ),
	 								array(  'id' 		=> 'header_padding_bottom',
	 										'name' 		=> __( 'Bottom', 'wp_email_template' ),
	 										'css'		=> 'width:40px;',
	 										'default'	=> 24 ),
									array(
